...
| `workflows/voice_transcribe_workflow.json` | 参考音声から文字抽出 | `Load Whisper (mtb)`、`Audio To Text (mtb)`、`ShowText\|pysssss` | [QwenLM/Qwen3-TTS](https://github.com/QwenLM/Qwen3-TTS) |
