...
const NAV_ICONS = {
  ...
  manualAbnormalSamples: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h2.5l1.5-5 3 10 2.2-7H19"/><path d="M4.5 19.5h15"/><path d="M4.5 4.5h15"/></svg>`,
...
const NAV_ITEMS = [
  ...
  { href: "./manual-abnormal-samples.html", labelKey: "nav.manualAbnormalSamples", icon: NAV_ICONS.manualAbnormalSamples },
