...
- 소설 관리: 소설 생성/편집/삭제, 프로젝트 통계, 자동 새로고침, 실제 ZIP 번들 다운로드, 소설 단위 프롬프트/워크플로 연결 지원
- 챕터 관리: 챕터 CRUD, 본문 보기/복사, 챕터 검색, AI→JSON, JSON 보기/편집/찾기 바꾸기, 역할 보기, 대사 미리보기 및 생성, 챕터 오디오 재생/다운로드/병합
- 대사 오디오: 단일 생성, 일괄 생성 후 대사 작업 큐 투입, 즉시 실행 또는 예약 실행 지원; 작업 페이지에서 자동 새로고침, 상세, 재생, 삭제, pending 수량 표시 지원
...
- 프롬프트 및 워크플로: 시스템/사용자 템플릿 관리, 사용자 템플릿으로 복사 지원; 음성 텍스트 추출, 대사 오디오 생성, 샘플 오디오 생성 등 ComfyUI 워크플로 내장
...
- 디버그 및 문서: ComfyUI debug 워크플로, 디버그 샘플 리소스, "소설을 오디오북으로 만드는 흐름" 다이어그램 제공
